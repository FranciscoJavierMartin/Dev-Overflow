<template>
  ...
  >
    <div
      v-if="isEditorReady"
      ref="editorElement"
      class="prose prose-sm prose-p:my-0 prose-ul:my-0 prose-ol:my-0 prose-code:my-0 prose-strong:my-0 prose-h1:my-0 prose-h2:my-0 prose-h3:my-0 prose-it sm:prose lg:prose-lg xl:prose-xl dark:prose-invert h-full w-full max-w-none px-4 py-6 focus:outline-none"
      role="region"
    />

    <div
      v-else
      class="tiptap-editor-placeholder text-muted-foreground flex h-full w-full items-center justify-center text-sm italic"
      aria-live="polite"
    >
